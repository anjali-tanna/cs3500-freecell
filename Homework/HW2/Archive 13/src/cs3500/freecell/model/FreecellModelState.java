...
/**
 * This interface represents different operations that a cs3500.freecell.freecell model must support
 * to return various aspects of its state. This interface does not provide any operations to mutate
 * the state of a cs3500.freecell.freecell model.
 *
...
public interface FreecellModelState<K> {
  ...
  /**
   * Get the number of cascade piles in this game of cs3500.freecell.freecell.
   *
  ...
  /**
   * Get the number of open piles in this game of cs3500.freecell.freecell.
   *
