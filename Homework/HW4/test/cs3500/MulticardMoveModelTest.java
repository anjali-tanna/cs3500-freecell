...
/** Tests for the MulticardMoveModel class. Tests a variety of different cases. */
public class MulticardMoveModelTest {

  Card clubQ = new Card(Value.QUEEN, Suit.CLUBS);
  Card heartA = new Card(Value.ACE, Suit.HEARTS);
  Card diamondQ = new Card(Value.QUEEN, Suit.DIAMOND);
  Card spadeK = new Card(Value.KING, Suit.SPADES);
  Card diamondA = new Card(Value.ACE, Suit.DIAMOND);
  Card heartK = new Card(Value.KING, Suit.HEARTS);
  MulticardMoveModel multiMove1 = new MulticardMoveModel();
  MulticardMoveModel multiMove2 = new MulticardMoveModel();
  List<Card> invalidDeck =
      new ArrayList<Card>(Arrays.asList(spadeK, clubQ, heartA, diamondQ, diamondA));

  // testing invalid destination
  @Test(expected = IllegalArgumentException.class)
  public void moveToInvalidDestTest() {
    multiMove2.move(PileType.CASCADE, 0, 8, PileType.CASCADE, 9);
  }

  // testing out of bound cascade pile
  @Test(expected = IllegalArgumentException.class)
  public void moveOutBoundCascTest() {
    multiMove2.move(PileType.CASCADE, 6, 8, PileType.CASCADE, 3);
  }

  // testing out of bound open pile
  @Test(expected = IllegalArgumentException.class)
  public void moveOutBoundOpenTest() {
    multiMove2.move(PileType.OPEN, 6, 8, PileType.CASCADE, 3);
  }

  // testing out of bound foundation pile
  @Test(expected = IllegalArgumentException.class)
  public void moveOutBoundFoundTest() {
    multiMove2.move(PileType.CASCADE, 0, 8, PileType.FOUNDATION, 4);
  }

  // testing move when the number of cards exceeds the maximum
  @Test(expected = IllegalArgumentException.class)
  public void moveCardMaxTest() {
    multiMove2.move(PileType.CASCADE, 0, 8, PileType.CASCADE, 3);
  }

  // testing move more then a card to foundation
  @Test(expected = IllegalArgumentException.class)
  public void moveMultipleToFoundTest() {
    multiMove2.move(PileType.CASCADE, 0, 8, PileType.FOUNDATION, 2);
  }

  // testing moving wrong card to foundation pile
  @Test(expected = IllegalArgumentException.class)
  public void moveWrongCardToFoundTest() {
    multiMove2.move(PileType.CASCADE, 4, 4, PileType.FOUNDATION, 4);
  }

  // testing moving more than one card to open pile
  @Test(expected = IllegalArgumentException.class)
  public void moveMultipleCardToOpenTest() {
    multiMove2.move(PileType.CASCADE, 0, 7, PileType.OPEN, 2);
  }

  // testing moving the wrong suit
  @Test(expected = IllegalArgumentException.class)
  public void moveWrongSuitTest() {
    multiMove2.move(PileType.CASCADE, 0, 9, PileType.CASCADE, 5);
  }

  // testing moving to an occupied open pile
  @Test(expected = IllegalArgumentException.class)
  public void moveToOccupiedOpenTest() {
    multiMove2.move(PileType.CASCADE, 2, 4, PileType.OPEN, 0);
  }

  @Test(expected = IllegalArgumentException.class)
  public void invalidDeckTest() {
    multiMove1.startGame(invalidDeck, 6, 3, false);
  }

  @Test(expected = IllegalArgumentException.class)
  public void invalidCascPileTest() {
    multiMove2.startGame(multiMove2.getDeck(), 3, 1, true);
  }

  @Test(expected = IllegalArgumentException.class)
  public void invalidOpenPileTest() {
    multiMove1.startGame(multiMove1.getDeck(), 5, 0, false);
  }
  ...
  @Test
  public void startGameDealShuffleTest() {
    freecellModel.startGame(freecellModel.getDeck(), 8, 4, true);
  ...
  @Test
  public void startGameNoShuffleDealAgainTest() {
